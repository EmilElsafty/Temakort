...
//ol.proj.get("EPSG:3857").setExtent([1365496.650660, 7477657.322688, 1409533.873150, 7498569.650386]);
var wms_layers = [];
...
var format_Sportogidrtsanlghvidovre_11 = new ol.format.GeoJSON();
var features_Sportogidrtsanlghvidovre_11 = format_Sportogidrtsanlghvidovre_11.readFeatures(json_Sportogidrtsanlghvidovre_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sportogidrtsanlghvidovre_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sportogidrtsanlghvidovre_11.addFeatures(features_Sportogidrtsanlghvidovre_11);
var lyr_Sportogidrtsanlghvidovre_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sportogidrtsanlghvidovre_11, 
                style: style_Sportogidrtsanlghvidovre_11,
                popuplayertitle: 'Sport- og idrætsanlæg hvidovre',
                interactive: true,
                title: '<img src="styles/legend/Sportogidrtsanlghvidovre_11.png" /> Sport- og idrætsanlæg hvidovre'
            });
var format_Praktiserendelger_12 = new ol.format.GeoJSON();
var features_Praktiserendelger_12 = format_Praktiserendelger_12.readFeatures(json_Praktiserendelger_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Praktiserendelger_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Praktiserendelger_12.addFeatures(features_Praktiserendelger_12);
var lyr_Praktiserendelger_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Praktiserendelger_12, 
                style: style_Praktiserendelger_12,
                popuplayertitle: 'Praktiserende læger',
                interactive: true,
                title: '<img src="styles/legend/Praktiserendelger_12.png" /> Praktiserende læger'
            });

lyr_Voyagernolabelsretina_0.setVisible(true);lyr_Positronnolabelsretina_1.setVisible(true);lyr_kommuneplan_2.setVisible(true);lyr_lokalplan_vedtag_3.setVisible(true);lyr_frededeomrder_4.setVisible(true);lyr_strandbeskyttelseHvidovre_5.setVisible(true);lyr_matStrandbeskyttelseFlade_Gaeldende_6.setVisible(false);lyr_folkeskolerrigtig_7.setVisible(true);lyr_Togstationer_8.setVisible(true);lyr_Parker_9.setVisible(true);lyr_Legeplads_10.setVisible(true);lyr_Sportogidrtsanlghvidovre_11.setVisible(true);lyr_Praktiserendelger_12.setVisible(true);
var layersList = [lyr_Voyagernolabelsretina_0,lyr_Positronnolabelsretina_1,lyr_kommuneplan_2,lyr_lokalplan_vedtag_3,lyr_frededeomrder_4,lyr_strandbeskyttelseHvidovre_5,lyr_matStrandbeskyttelseFlade_Gaeldende_6,lyr_folkeskolerrigtig_7,lyr_Togstationer_8,lyr_Parker_9,lyr_Legeplads_10,lyr_Sportogidrtsanlghvidovre_11,lyr_Praktiserendelger_12];
...
lyr_Sportogidrtsanlghvidovre_11.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
lyr_Praktiserendelger_12.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
...
lyr_Sportogidrtsanlghvidovre_11.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
lyr_Praktiserendelger_12.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
...
lyr_folkeskolerrigtig_7.set('fieldLabels', {'Skolenavn': 'hidden field', 'Adresse': 'no label', 'By': 'inline label - always visible', 'Hjemmeside': 'inline label - always visible', });
...
lyr_Sportogidrtsanlghvidovre_11.set('fieldLabels', {'fid': 'no label', 'Navn': 'inline label - always visible', 'Adresse': 'inline label - always visible', 'By': 'inline label - always visible', 'Hjemmeside': 'inline label - always visible', });
lyr_Praktiserendelger_12.set('fieldLabels', {'fid': 'no label', 'Navn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', });
lyr_Praktiserendelger_12.on('precompose', function(evt) {
